...
describe.concurrent('Scale Value', () => {
    ...
    it('Specific 1', () => {
        ...
        expect(scaledValue).toBeGreaterThanOrEqual(204)
        expect(scaledValue).toBeLessThanOrEqual(208)
    })

    it('Specific 2', () => {
        const toScale = 80
        const scaledValue = scaleValue(toScale, 50, 100)
        expect(scaledValue).toBeGreaterThanOrEqual(153)
        expect(scaledValue).toBeLessThanOrEqual(157)
    })
    ...
    it('Specific 4', () => {
        const toScale = 100
        const scaledValue = scaleValue(toScale, 0, 100)
        expect(scaledValue).toBeGreaterThanOrEqual(254)
        expect(scaledValue).toBeLessThanOrEqual(255)
    })
    ...
    it('Specific 5', () => {
        const toScale = 99
        const scaledValue = scaleValue(toScale, 0, 100)
        expect(scaledValue).toBeGreaterThanOrEqual(252)
        expect(scaledValue).toBeLessThanOrEqual(255)
    })
    ...
    it('Specific 6', () => {
        ...
        expect(scaledValue).toBeGreaterThanOrEqual(120)
        expect(scaledValue).toBeLessThanOrEqual(124)
    })
    ...
    it('Specific 11', () => {
        ...
        const scaledValue = scaleValue(toScale, 0, 100)
        expect(scaledValue).toBeGreaterThanOrEqual(0)
        expect(scaledValue).toBeLessThanOrEqual(3)
    })
