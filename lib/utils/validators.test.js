...
import { isArrayOfIntegers, isValueWithinTheRange } from './validators'
...
describe.concurrent('Is Array of Integers', () => {
    ...
    it('No param', () => {
        expect(() => isArrayOfIntegers()).toThrow(
            'Parameter of generateEntropy function was not set.',
        )
    })
    ...
    it('Not array param', () => {
        ...
        expect(() => isArrayOfIntegers(param)).toThrow(
            'Parameter of generateEntropy should be an Array.',
        )
    })
